...
public struct APNSBroadcastNotification<ContentState: Encodable & Sendable>: APNSMessage {
    enum CodingKeys: CodingKey {
        case aps
    }

    /// The fixed content to indicate that this is a background notification.
    private var aps: APNSBroadcastNotificationAPSStorage<ContentState>
    ...
    public var event: APNSBroadcastNotificationEvent {
        get {
            return APNSBroadcastNotificationEvent(rawValue: self.aps.event)
        }
    ...
    public var dismissalDate: APNSBroadcastDismissalDate? {
        get {
    ...
    /// Initializes a new ``APNSBroadcastNotification``.
    ///
    ...
    ///   - topic: The topic for the notification.
    ...
    public init(
        ...
        event: APNSBroadcastNotificationEvent,
        alert: APNSAlertNotificationContent? = nil,
        timestamp: Int,
        dismissalDate: APNSBroadcastDismissalDate = .none,
        staleDate: Int? = nil,
        relevanceScore: Double? = nil
    ) {
        self.aps = APNSBroadcastNotificationAPSStorage(
            timestamp: timestamp,
